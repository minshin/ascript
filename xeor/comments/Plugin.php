...
class Plugin extends PluginBase
{
    ...
    protected function registerConsole()
    {
         ...
         */
        $this->registerConsoleCommand('comments.fixtree', 'Xeor\Comments\Console\CommentsFixTree');
    }
    ...
    public function registerMarkupTags()
    {
        return [
            'functions' => [
                'comments_number' => function($uri = '') { return Db::table('xeor_comments_comments')->where('uri', $uri)->where('published', true)->count(); }
            ]
        ];
    }
